...
void Vexp___024root___eval_triggers__ico(Vexp___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vexp___024root___eval_triggers__ico\n"); );
...
VL_INLINE_OPT void Vexp___024root___ico_sequent__TOP__0(Vexp___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vexp___024root___ico_sequent__TOP__0\n"); );
    Vexp__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    vlSymsp->TOP____024unit.compute_exp__Vstatic__sum 
        = __Vtemp_100;
    vlSymsp->TOP____024unit.compute_exp__Vstatic__term_idx = 0x15U;
...
void Vexp___024root___eval_triggers__act(Vexp___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vexp___024root___eval_triggers__act\n"); );
    Vexp__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
#ifdef VL_DEBUG
