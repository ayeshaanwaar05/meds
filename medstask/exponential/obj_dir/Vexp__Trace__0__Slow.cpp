...
VL_ATTR_COLD void Vexp___024root__trace_init_sub__TOP____024unit__0(Vexp___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+3,0,"compute_exp__Vstatic__term_number",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INT, false,-1, 31,0);
...
VL_ATTR_COLD void Vexp___024root__trace_full_0_sub_0(Vexp___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+3,(vlSymsp->TOP____024unit.compute_exp__Vstatic__term_number),32);
