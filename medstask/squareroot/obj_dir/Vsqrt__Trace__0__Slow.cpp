...
VL_ATTR_COLD void Vsqrt___024root__trace_init_sub__TOP__0(Vsqrt___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->popPrefix();
    tracep->declDouble(c+1,0,"input_value",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::DOUBLE, false,-1);
    tracep->declDouble(c+3,0,"result",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::DOUBLE, false,-1);
...
VL_ATTR_COLD void Vsqrt___024root__trace_init_sub__TOP____024unit__0(Vsqrt___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    const int c = vlSymsp->__Vm_baseCode;
    // Body
    tracep->declDouble(c+5,0,"squareroot__Vstatic__x",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::DOUBLE, false,-1);
...
VL_ATTR_COLD void Vsqrt___024root__trace_full_0_sub_0(Vsqrt___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullDouble(oldp+1,(vlSelfRef.input_value));
    bufp->fullDouble(oldp+3,(vlSelfRef.result));
    bufp->fullDouble(oldp+5,(vlSymsp->TOP____024unit.squareroot__Vstatic__x));
