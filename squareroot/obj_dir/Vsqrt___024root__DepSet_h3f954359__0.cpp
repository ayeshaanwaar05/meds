...
#endif
            VL_FATAL_MT("sqrt.sv", 3, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("sqrt.sv", 3, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("sqrt.sv", 3, "", "Active region did not converge.");
            }
