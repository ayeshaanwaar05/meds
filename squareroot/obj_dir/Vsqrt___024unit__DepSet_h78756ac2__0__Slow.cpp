...
VL_ATTR_COLD void Vsqrt___024unit___ctor_var_reset(Vsqrt___024unit* vlSelf) {
    ...
    // Body
    vlSelf->squareroot__Vstatic__start_pt = 0;
    vlSelf->squareroot__Vstatic__end_pt = 0;
    vlSelf->squareroot__Vstatic__mid_pt = 0;
    vlSelf->squareroot__Vstatic__tolerance = 0;
    vlSelf->squareroot__Vstatic__difference = 0;
}
