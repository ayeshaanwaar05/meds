...
#endif
            VL_FATAL_MT("sqrt.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vsqrt___024root____Vm_traceActivitySetAll(Vsqrt___024root* vlSelf);
...
VL_ATTR_COLD void Vsqrt___024root___eval_stl(Vsqrt___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        ...
        Vsqrt___024root____Vm_traceActivitySetAll(vlSelf);
    }
}
...
VL_ATTR_COLD void Vsqrt___024root____Vm_traceActivitySetAll(Vsqrt___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsqrt___024root____Vm_traceActivitySetAll\n"); );
    Vsqrt__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
